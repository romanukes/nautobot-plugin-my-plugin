...
def docker_compose(context, command, **kwargs):
    ...
    compose_command = f'docker-compose --project-name {context.my_plugin.project_name} --project-directory "{context.my_plugin.compose_dir}"'
...
def docs(context):
    ...
    if is_truthy(context.my_plugin.local):
        ...
        print("Only used when developing locally (i.e. context.my_plugin.local=True)!")
...
def unittest(context, keepdb=False, label="my_plugin", failfast=False, buffer=True):
